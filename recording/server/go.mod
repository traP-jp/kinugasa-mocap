module github.com/comavius/kinugasa-mocap/recording/server

go 1.26

replace github.com/comavius/kinugasa-mocap/recording/config v0.0.0 => ../config

require (
	github.com/comavius/kinugasa-mocap/recording/config v0.0.0
